...
% ── Title ─────────────────────────────────────────────────────────────────
\title{%
  \textbf{Ensemble AI Screening of 7{,}467 TP53 Variants:\\
  Redefining Clinical Pathogenicity for Variants of Uncertain Significance}%
}
...
AlphaMissense---to score the complete landscape of 7{,}467 possible
single-amino-acid substitutions in TP53 (UniProt P04637).  Of these,
1{,}199 ClinVar VUS were matched to AlphaMissense predictions and
cross-referenced.  Structural validation was performed against PDB 1TUP
(Cho et al., 1994).
...
In this study, we systematically apply ESM-2 and AlphaMissense to the full
landscape of 7{,}467 possible TP53 single-amino-acid substitutions and
cross-reference the results against 1{,}211 ClinVar VUS.  We identify 349
...
\begin{itemize}[nosep,leftmargin=1.5em]
  ...
  \item \textbf{GitHub:} \href{https://github.com/mahaddevx}{github.com/mahaddevx}
  \item \textbf{Project Repository:} \href{https://github.com/mahaddevx/TP53-AI-Screening}{github.com/mahaddevx/TP53-AI-Screening}
\end{itemize}
